...
class BenchmarkRunner:
    ...
    async def _run_single_safe(self, test_case: Dict) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "ragas": {"faithfulness": 0.0, "relevancy": 0.0, "retrieval": {}},
                "judge": {
                    "final_score": 1.0, "agreement_rate": 0.0,
                    "error": "Timeout"
                },
                "status": "timeout",
            }
            ...
            return {
                ...
                "ragas": {"faithfulness": 0.0, "relevancy": 0.0, "retrieval": {}},
                "judge": {"final_score": 1.0, "agreement_rate": 0.0, "error": str(e)},
                "status": "error",
            }
        ...
        ragas_scores = await asyncio.wait_for(
            self.evaluator.calculate_ragas_metrics(
        ...
        if "usage" in response.get("metadata", {}):
            self.total_tokens += response["metadata"]["usage"].get("total_tokens", 0)
        ...
        return {
            ...
            "contexts_used": response.get("contexts", []),
            "retrieved_ids": response.get("retrieved_ids", []),
    ...
    async def run_all(self, dataset: List[Dict], batch_size: int = 3) -> List[Dict]:
        ...
        print(f"  Running benchmark on {total_cases} cases (batch_size={batch_size}, concurrency={3})...")
